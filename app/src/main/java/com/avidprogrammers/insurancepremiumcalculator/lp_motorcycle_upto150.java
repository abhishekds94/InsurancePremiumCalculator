...
public class lp_motorcycle_upto150 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    TextView lppaupto150_paod_value, lppaupto150_act, lppaupto150_tax, lppaupto150_total_premium;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(lp_motorcycle_upto150.this);
        ...
        lppaupto150_act = (TextView) findViewById(R.id.lppaupto150_act_value);
        lppaupto150_paod_value = (TextView) findViewById(R.id.lppaupto150);
        lppaupto150_tax = (TextView) findViewById(R.id.lppaupto150_tax_value);
        lppaupto150_total_premium = findViewById(R.id.lppaupto150_total_value);

        lppaupto150_act.setText(b.getCharSequence("lp_motocyc_calc_upto150_act"));
        lppaupto150_paod_value.setText(b.getCharSequence("lp_motocyc_calc_upto150_paod"));
        lppaupto150_tax.setText(b.getCharSequence("lp_motocyc_calc_upto150_tax"));

        int act = Integer.parseInt(String.valueOf(lppaupto150_act.getText().toString()));
        int paodv = Integer.parseInt(String.valueOf(lppaupto150_paod_value.getText().toString()));
        int tax = (int)Math.round((act + paodv)*1.18);
        lppaupto150_total_premium.setText(String.valueOf(tax));

        shareBtn = (CircleButton) findViewById(R.id.sharebtnupto150);
        shareBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PermissionsChecker checker = new PermissionsChecker(lp_motorcycle_upto150.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(lp_motorcycle_upto150.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
    ...
    View.OnClickListener listener_homebtnupto150 = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(lp_motorcycle_upto150.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto150_act.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto150_paod_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto150_total_premium.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            Uri uri = FileProvider.getUriForFile(lp_motorcycle_upto150.this,BuildConfig.APPLICATION_ID + ".provider",file);
