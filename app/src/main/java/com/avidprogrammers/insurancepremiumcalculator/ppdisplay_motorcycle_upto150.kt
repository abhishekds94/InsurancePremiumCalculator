 ...
 */
class ppdisplay_motorcycle_upto150 : AppCompatActivity(), ConnectivityReceiverListener {
    ...
    var file: File? = null
    var pp_motorcycle_upto150_IDV_value: TextView? = null
    var pp_motorcycle_upto150_date_value: TextView? = null
    var pp_motorcycle_upto150_zone_value: TextView? = null
    var pp_motorcycle_upto150_cc_value: TextView? = null
    var pp_motorcycle_upto150_nd_value: TextView? = null
    var pp_motorcycle_upto150_ndd_value: TextView? = null
    var pp_motorcycle_upto150_uwd_value: TextView? = null
    var pp_motorcycle_upto150_ncb_value: TextView? = null
    var pp_motorcycle_upto150_od_value: TextView? = null
    var pp_motorcycle_upto150_ab_value: TextView? = null
    var pp_motorcycle_upto150_b_value: TextView? = null
    var ppdisplay_motorcycle_upto150_total_value: TextView? = null
    var ppdisplay_motorcycle_upto150_paod_value: TextView? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@ppdisplay_motorcycle_upto150)
        setContentView(R.layout.ppdisplay_motorcycle_upto150)

/*        mAdView = (AdView) findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);*/share_btn =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_share) as CircleButton?
        val b: Bundle = getIntent().getExtras()!!
        pp_motorcycle_upto150_IDV_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_IDV_value) as TextView?
        pp_motorcycle_upto150_date_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_date_value) as TextView?
        pp_motorcycle_upto150_zone_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_zone_value) as TextView?
        pp_motorcycle_upto150_cc_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_cc_value) as TextView?
        pp_motorcycle_upto150_nd_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_nd_value) as TextView?
        pp_motorcycle_upto150_ndd_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_ndd_value) as TextView?
        pp_motorcycle_upto150_uwd_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_uwd_value) as TextView?
        pp_motorcycle_upto150_ncb_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_ncb_value) as TextView?
        pp_motorcycle_upto150_od_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_od_value) as TextView?
        pp_motorcycle_upto150_ab_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_ab_value) as TextView?
        pp_motorcycle_upto150_b_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_b_value) as TextView?
        ppdisplay_motorcycle_upto150_paod_value =
            findViewById<TextView>(R.id.ppdisplay_motorcycle_upto150_pa_value)
        ppdisplay_motorcycle_upto150_total_value =
            findViewById<View>(R.id.ppdisplay_motorcycle_upto150_total_value) as TextView?
        pp_motorcycle_upto150_IDV_value!!.text =
            b.getCharSequence("pp_motorcycle_upto150_idv_value")
        pp_motorcycle_upto150_date_value!!.text =
            b.getCharSequence("pp_motorcycle_upto150_date_value")
        pp_motorcycle_upto150_zone_value!!.text = b.getCharSequence("pp_motorcycle_upto150_zone")
        pp_motorcycle_upto150_cc_value!!.text = b.getCharSequence("pp_motorcycle_upto150_cc_value")
        pp_motorcycle_upto150_nd_value!!.text = b.getCharSequence("pp_motorcycle_upto150_nd_value")
        pp_motorcycle_upto150_ndd_value!!.text =
            b.getCharSequence("pp_motorcycle_upto150_ndd_value")
        pp_motorcycle_upto150_uwd_value!!.text =
            b.getCharSequence("pp_motorcycle_upto150_uwd_value")
        ppdisplay_motorcycle_upto150_paod_value!!.text =
            b.getCharSequence("pp_motorcycle_upto150_paod_value")
        getSupportActionBar()!!.setDisplayHomeAsUpEnabled(true)
        getSupportActionBar()!!.setTitle("Motorcycle Package Policy")
        share_btn!!.setOnClickListener {
            val checker = PermissionsChecker(this@ppdisplay_motorcycle_upto150)
            if (checker.lacksPermissions(*PermissionsChecker.REQUIRED_PERMISSION)) {
                PermissionsActivity.startActivityForResult(
                    this@ppdisplay_motorcycle_upto150,
        ...
        findViewById<View>(R.id.ppdisplay_motorcycle_upto150_home).setOnClickListener(
            listener_ppdisplay_motorcycle_upto150_home
        )


        //Calculation
        val d1 = b.getString("pp_motorcycle_upto150_date_value").toString()
        val s = d1
        val y = b.getInt("year")
        ...
        if (b.getString("pp_motorcycle_upto150_zone") == "A") {
            if (diffInDays < 1825) {
                val idv_value =
                    Integer.valueOf(b.getString("pp_motorcycle_upto150_idv_value"))
                        .toDouble()
        ...
        } else if (b.getString("pp_motorcycle_upto150_zone") == "B") {
            if (diffInDays < 1825) {
                val idv_value =
                    Integer.valueOf(b.getString("pp_motorcycle_upto150_idv_value"))
                        .toDouble()
...
//        }
        ...
        val uw_value =
            Integer.valueOf(b.getString("pp_motorcycle_upto150_uwd_value")).toDouble()
        ...
        var nd_value1 = 0.0
        val radio_button_value = b.getString("pp_motorcycle_upto150_nd")
        ...
        if (nd_value1 == 0.0) {
            pp_motorcycle_upto150_nd_value!!.text = "0"
        } else {
            pp_motorcycle_upto150_nd_value!!.text = b.getString("pp_motorcycle_upto150_nd_value")
        ...
        val ndd_value =
            Integer.valueOf(b.getString("pp_motorcycle_upto150_ndd_value")).toDouble()
        ...
        // Calculation of NCB
        val spinner_value =
            Integer.valueOf(b.getString("pp_motorcycle_upto150_spinner_value"))
                .toDouble()
        ...
        pp_motorcycle_upto150_ncb_value!!.text = b.getString("pp_motorcycle_upto150_spinner_value")
        //pp_motorcycle_upto150_ncb_value.setText(String.valueOf(rounded_ncb_value_int));
        pp_motorcycle_upto150_od_value!!.text = rounded_ncb_value_int.toString()
...
//        Toast.makeText(getApplicationContext(), " NCB:  " + value_spin2,  Toast.LENGTH_SHORT).show();
        ...
        pp_total_premium =
            (714 + Integer.valueOf(ppdisplay_motorcycle_upto150_paod_value!!.text.toString())).toDouble()
        val total = (714 + Integer.valueOf(
            ppdisplay_motorcycle_upto150_paod_value!!.text.toString()
        )).toDouble()
        ...
        pp_motorcycle_upto150_b_value!!.text = rounded_total_premium_int.toString()
        val total_ab = rounded_total_premium.toDouble() + rounded_ncb_value.toDouble()
        val total_ab_int = total_ab.toInt()
        pp_motorcycle_upto150_ab_value!!.text = total_ab_int.toString()
        ...
        ppdisplay_motorcycle_upto150_total_value!!.text = rounded_total_AB_int.toString()
    }

    var listener_ppdisplay_motorcycle_upto150_home = View.OnClickListener {
        val intent = Intent(this@ppdisplay_motorcycle_upto150, home_activity::class.java)
    ...
    private fun settingUpPDF(document: Document) {
        ...
        try {
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + pp_motorcycle_upto150_IDV_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_date_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_zone_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_cc_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_nd_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_ndd_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_uwd_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(pp_motorcycle_upto150_ncb_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + pp_motorcycle_upto150_od_value!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + ppdisplay_motorcycle_upto150_paod_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + pp_motorcycle_upto150_b_value!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + pp_motorcycle_upto150_ab_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + ppdisplay_motorcycle_upto150_total_value!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
