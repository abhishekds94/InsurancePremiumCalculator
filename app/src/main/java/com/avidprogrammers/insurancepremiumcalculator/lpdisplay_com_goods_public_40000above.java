...
public class lpdisplay_com_goods_public_40000above extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(lpdisplay_com_goods_public_40000above.this);
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        int nfpp = Integer.parseInt(lp_com_goods_public_40000above_coolie.getText().toString());
        int coolie = Integer.parseInt(lp_com_goods_public_40000above_nfpp.getText().toString());
        nfpp = nfpp*75;
        coolie = coolie*50;
        lp_com_goods_public_40000above_coolie.setText(String.valueOf(coolie));
        lp_com_goods_public_40000above_nfpp.setText(String.valueOf(nfpp));

        findViewById(R.id.lpdisplay_com_goods_public_40000above_home).setOnClickListener(this.listener_lpdisplay_com_goods_public_40000above_home);
        share_btn = (CircleButton) findViewById(R.id.lpdisplay_com_goods_public_40000above_share);
        share_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PermissionsChecker checker = new PermissionsChecker(lpdisplay_com_goods_public_40000above.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(lpdisplay_com_goods_public_40000above.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
        ...
        String act_val = b.getCharSequence("lp_com_goods_public_40000above_act").toString();
        String paod_value = b.getCharSequence("lp_com_goods_public_40000above_paod").toString();
    ...
    View.OnClickListener listener_lpdisplay_com_goods_public_40000above_home = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(lpdisplay_com_goods_public_40000above.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_com_goods_public_40000above_act.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_com_goods_public_40000above_paod.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_com_goods_public_40000above_ll.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(lp_com_goods_public_40000above_coolie.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(lp_com_goods_public_40000above_nfpp.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_com_goods_public_40000above_total.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            Uri uri = FileProvider.getUriForFile(lpdisplay_com_goods_public_40000above.this, BuildConfig.APPLICATION_ID + ".provider",file);
