...
public class lp_motorcycle_upto350 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    TextView lppaupto350_paod_value, lppaupto350_act, lppaupto350_tax, lppaupto350_total_premium;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(lp_motorcycle_upto350.this);
        ...
        lppaupto350_paod_value =  findViewById(R.id.lppaupto350);

        Bundle b = getIntent().getExtras();
        lppaupto350_act = (TextView) findViewById(R.id.lppaupto350_act_value);
        lppaupto350_paod_value = (TextView) findViewById(R.id.lppaupto350);
        lppaupto350_tax = (TextView) findViewById(R.id.lppaupto350_tax_value);
        lppaupto350_total_premium = findViewById(R.id.lppaupto350_total_value);

        lppaupto350_act.setText(b.getCharSequence("lp_motocyc_calc_upto350_act"));
        lppaupto350_paod_value.setText(b.getCharSequence("lp_motocyc_calc_upto350_paod"));
        lppaupto350_tax.setText(b.getCharSequence("lp_motocyc_calc_upto350_tax"));

        int act = Integer.parseInt(String.valueOf(lppaupto350_act.getText().toString()));
        int paodv = Integer.parseInt(String.valueOf(lppaupto350_paod_value.getText().toString()));
        int tax = (int)Math.round((act + paodv)*1.18);
        lppaupto350_total_premium.setText(String.valueOf(tax));



        findViewById(R.id.homebtnupto350).setOnClickListener(listener_homebtnupto350);

        shareBtn = (CircleButton) findViewById(R.id.sharebtnupto350);
        shareBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PermissionsChecker checker = new PermissionsChecker(lp_motorcycle_upto350.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(lp_motorcycle_upto350.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
    ...
    View.OnClickListener listener_homebtnupto350 = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(lp_motorcycle_upto350.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto350_act.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto350_paod_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto350_total_premium.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            Uri uri = FileProvider.getUriForFile(lp_motorcycle_upto350.this,BuildConfig.APPLICATION_ID + ".provider",file);
