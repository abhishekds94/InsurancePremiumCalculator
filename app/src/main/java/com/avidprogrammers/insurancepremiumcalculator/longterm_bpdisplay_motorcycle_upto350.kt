 ...
 */
class longterm_bpdisplay_motorcycle_upto350 : AppCompatActivity(), ConnectivityReceiverListener {
    ...
    var file: File? = null
    var lt_bp_motorcycle_upto350_IDV_value: TextView? = null
    var lt_bp_motorcycle_upto350_date_value: TextView? = null
    var lt_bp_motorcycle_upto350_zone_value: TextView? = null
    var lt_bp_motorcycle_upto350_cc_value: TextView? = null
    var lt_bp_motorcycle_upto350_nd_value: TextView? = null
    var lt_bp_motorcycle_upto350_ndd_value: TextView? = null
    var lt_bp_motorcycle_upto350_uwd_value: TextView? = null
    var lt_bp_motorcycle_upto350_ncb_value: TextView? = null
    var lt_bp_motorcycle_upto350_od_value: TextView? = null
    var lt_bp_motorcycle_upto350_ab_value: TextView? = null
    var lt_bp_motorcycle_upto350_b_value: TextView? = null
    var lt_bpdisplay_motorcycle_upto350_total_value: TextView? = null
    var lt_bpdisplay_motorcycle_upto350_paod_value: TextView? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@longterm_bpdisplay_motorcycle_upto350)
        setContentView(R.layout.longterm_bpdisplay_motorcycle_upto350)

/*        mAdView = (AdView) findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);*/share_btn =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_share) as CircleButton?
        val b: Bundle? = getIntent().getExtras()
        lt_bp_motorcycle_upto350_IDV_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_IDV_value) as TextView?
        lt_bp_motorcycle_upto350_date_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_date_value) as TextView?
        lt_bp_motorcycle_upto350_zone_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_zone_value) as TextView?
        lt_bp_motorcycle_upto350_cc_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_cc_value) as TextView?
        lt_bp_motorcycle_upto350_nd_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_nd_value) as TextView?
        lt_bp_motorcycle_upto350_ndd_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_ndd_value) as TextView?
        lt_bp_motorcycle_upto350_uwd_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_uwd_value) as TextView?
        lt_bp_motorcycle_upto350_ncb_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_ncb_value) as TextView?
        lt_bp_motorcycle_upto350_od_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_od_value) as TextView?
        lt_bp_motorcycle_upto350_ab_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_ab_value) as TextView?
        lt_bp_motorcycle_upto350_b_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_b_value) as TextView?
        lt_bpdisplay_motorcycle_upto350_paod_value =
            findViewById<TextView>(R.id.lt_bpdisplay_motorcycle_upto350_pa_value)
        lt_bpdisplay_motorcycle_upto350_total_value =
            findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_total_value) as TextView?
        lt_bp_motorcycle_upto350_IDV_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_idv_value")
        lt_bp_motorcycle_upto350_date_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_date_value")
        lt_bp_motorcycle_upto350_zone_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_zone")
        lt_bp_motorcycle_upto350_cc_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_cc_value")
        lt_bp_motorcycle_upto350_nd_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_nd_value")
        lt_bp_motorcycle_upto350_ndd_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_ndd_value")
        lt_bp_motorcycle_upto350_uwd_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_uwd_value")
        lt_bpdisplay_motorcycle_upto350_paod_value!!.text =
            b!!.getCharSequence("lt_bp_motorcycle_upto350_paod_value")
        getSupportActionBar()!!.setDisplayHomeAsUpEnabled(true)
        getSupportActionBar()!!.setTitle("Motorcycle Package Policy")
        share_btn!!.setOnClickListener {
            val checker = PermissionsChecker(this@longterm_bpdisplay_motorcycle_upto350)
            if (checker.lacksPermissions(*PermissionsChecker.REQUIRED_PERMISSION)) {
                PermissionsActivity.startActivityForResult(
                    this@longterm_bpdisplay_motorcycle_upto350,
        ...
        findViewById<View>(R.id.lt_bpdisplay_motorcycle_upto350_home).setOnClickListener(
            listener_lt_bpdisplay_motorcycle_upto350_home
        )


        //Calculation
        val d1 = b.getString("lt_bp_motorcycle_upto350_date_value").toString()
        val s = d1
        val y = b.getInt("year")
        ...
        if (b.getString("lt_bp_motorcycle_upto350_zone") == "A") {
            if (diffInDays < 1825) {
                val idv_value =
                    Integer.valueOf(b.getString("lt_bp_motorcycle_upto350_idv_value"))
                        .toDouble()
        ...
        } else if (b.getString("lt_bp_motorcycle_upto350_zone") == "B") {
            if (diffInDays < 1825) {
                val idv_value =
                    Integer.valueOf(b.getString("lt_bp_motorcycle_upto350_idv_value"))
                        .toDouble()
...
//        }
        ...
        val uw_value =
            Integer.valueOf(b.getString("lt_bp_motorcycle_upto350_uwd_value")).toDouble()
        ...
        var nd_value1 = 0.0
        val radio_button_value = b.getString("lt_bp_motorcycle_upto350_nd")
...
//                .show()
        ...
        if (nd_value1 == 0.0) {
            lt_bp_motorcycle_upto350_nd_value!!.text = "0"
        } else {
            lt_bp_motorcycle_upto350_nd_value!!.text =
                b.getString("lt_bp_motorcycle_upto350_nd_value")
        ...
        val ndd_value =
            Integer.valueOf(b.getString("lt_bp_motorcycle_upto350_ndd_value")).toDouble()
        ...
        // Calculation of NCB
        val spinner_value =
            Integer.valueOf(b.getString("lt_bp_motorcycle_upto350_spinner_value"))
                .toDouble()
        ...
        lt_bp_motorcycle_upto350_ncb_value!!.text =
            b.getString("lt_bp_motorcycle_upto350_spinner_value")
        //lt_bp_motorcycle_upto350_ncb_value.setText(String.valueOf(rounded_ncb_value_int));
        lt_bp_motorcycle_upto350_od_value!!.text = rounded_ncb_value_int.toString()
...
//        Toast.makeText(getApplicationContext(), " NCB:  " + value_spin2,  Toast.LENGTH_SHORT).show();
        ...
        lt_bp_motorcycle_upto350_b_value!!.text = rounded_total_premium_int.toString()
        val total_ab = rounded_total_premium.toDouble() + rounded_ncb_value.toDouble()
        val total_ab_int = total_ab.toInt()
        lt_bp_motorcycle_upto350_ab_value!!.text = total_ab_int.toString()
        ...
        lt_bpdisplay_motorcycle_upto350_total_value!!.text = rounded_total_AB_int.toString()
    }

    var listener_lt_bpdisplay_motorcycle_upto350_home = View.OnClickListener {
        val intent = Intent(this@longterm_bpdisplay_motorcycle_upto350, home_activity::class.java)
    ...
    private fun settingUpPDF(document: Document) {
        ...
        try {
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_bp_motorcycle_upto350_IDV_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_date_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_zone_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_cc_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_nd_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_ndd_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_uwd_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lt_bp_motorcycle_upto350_ncb_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_bp_motorcycle_upto350_od_value!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_bpdisplay_motorcycle_upto350_paod_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_bp_motorcycle_upto350_b_value!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_bp_motorcycle_upto350_ab_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            p.add(
                Chunk(
                    "Rs. " + lt_bpdisplay_motorcycle_upto350_total_value!!.text.toString(),
                    white
                )
            )
            pdfPCell = PdfPCell()
