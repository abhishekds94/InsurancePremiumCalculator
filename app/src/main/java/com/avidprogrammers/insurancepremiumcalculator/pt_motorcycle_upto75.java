...
public class pt_motorcycle_upto75 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(pt_motorcycle_upto75.this);
...
/*        mAdView = (AdView) findViewById(R.id.adView);
    ...
    View.OnClickListener listener_motorcycle_upto75_lp = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(pt_motorcycle_upto75.this, lp_motorcycle_calc_upto75.class);
            startActivity(intent);
        }
    };
