 ...
 */
class lpdisplay_bus_upto18 : AppCompatActivity(), ConnectivityReceiverListener {
    var conn: ConnectivityReceiver? = null
    var checkingStatus: CheckingStatus? = null
    private val mAdView: AdView? = null
    var share_btn: CircleButton? = null
    var file: File? = null
    var lp_bus_upto18_act: TextView? = null
    var lp_bus_upto18_paod: TextView? = null
    var lp_bus_upto18_tax: TextView? = null
    var lp_bus_scpassengers_upto18: TextView? = null
    var lp_bus_driver_upto18: TextView? = null
    var lp_bus_conductor_upto18: TextView? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@lpdisplay_bus_upto18)
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        lp_bus_upto18_act = findViewById<View>(R.id.lpdisplay_bus_upto18_act_value) as TextView?
        lp_bus_upto18_paod = findViewById<View>(R.id.lpdisplay_bus_upto18_paod_value) as TextView?
        lp_bus_upto18_tax = findViewById<View>(R.id.lpdisplay_bus_upto18_tax_value) as TextView?
        lp_bus_scpassengers_upto18 =
            findViewById<View>(R.id.lpdisplay_bus_upto18_passrisk_value) as TextView?
        lp_bus_driver_upto18 =
            findViewById<View>(R.id.lpdisplay_bus_upto18_lldriver_value) as TextView?
        lp_bus_conductor_upto18 =
            findViewById<View>(R.id.lpdisplay_bus_upto18_llconductor_value) as TextView?
        lp_bus_total_premium =
            findViewById<View>(R.id.lpdisplay_bus_upto18_total_value) as TextView?
        lp_bus_upto18_act!!.text = b.getCharSequence("lp_bus_upto18_act")
        lp_bus_upto18_paod!!.text = b.getCharSequence("lp_bus_upto18_paod")
        lp_bus_upto18_tax!!.text = b.getCharSequence("lp_bus_upto18_tax")
        //
        lp_bus_scpassengers_upto18!!.text =
            (b.getCharSequence("lp_bus_scpassengers_upto18").toString().toInt() * 877).toString()
        lp_bus_driver_upto18!!.text =
            (b.getCharSequence("lp_bus_driver_upto18").toString().toInt() * 50).toString()
        lp_bus_conductor_upto18!!.text =
            (b.getCharSequence("lp_bus_conductor_upto18").toString().toInt() * 50).toString()
        ...
        findViewById<View>(R.id.lpdisplay_bus_upto18_home).setOnClickListener(
            listener_lpdisplay_bus_upto18_home
        )
        share_btn = findViewById<View>(R.id.lpdisplay_bus_upto18_share) as CircleButton?
        share_btn!!.setOnClickListener {
            val checker = PermissionsChecker(this@lpdisplay_bus_upto18)
            if (checker.lacksPermissions(*PermissionsChecker.REQUIRED_PERMISSION)) {
                PermissionsActivity.startActivityForResult(
                    this@lpdisplay_bus_upto18,
    ...
    var listener_lpdisplay_bus_upto18_home = View.OnClickListener {
        val intent = Intent(this@lpdisplay_bus_upto18, home_activity::class.java)
    ...
    private fun settingUpPDF(document: Document) {
        ...
        try {
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_bus_upto18_act!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_bus_upto18_paod!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_bus_scpassengers_upto18!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_bus_driver_upto18!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lp_bus_conductor_upto18!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
