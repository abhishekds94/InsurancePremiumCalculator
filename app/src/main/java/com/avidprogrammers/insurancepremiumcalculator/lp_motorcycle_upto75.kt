...
public class lp_motorcycle_upto75 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    File file;
    TextView lppaupto75_paod_value, lppaupto75_act, lppaupto75_tax, lppaupto75_total_premium;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(lp_motorcycle_upto75.this);
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        //lppaupto75_paod_value =  findViewById(R.id.lppaupto75);

        findViewById(R.id.homebtnupto75).setOnClickListener(listener_homebtnupto75);

        Bundle b = getIntent().getExtras();
        lppaupto75_act = (TextView) findViewById(R.id.lppaupto75_act_value);
        lppaupto75_paod_value = (TextView) findViewById(R.id.lppaupto75);
        lppaupto75_tax = (TextView) findViewById(R.id.lppaupto75_tax_value);
        lppaupto75_total_premium = findViewById(R.id.lppaupto75_total_value);

        lppaupto75_act.setText(b.getCharSequence("lp_motocyc_calc_upto75_act"));
        lppaupto75_paod_value.setText(b.getCharSequence("lp_motocyc_calc_upto75_paod"));
        lppaupto75_tax.setText(b.getCharSequence("lp_motocyc_calc_upto75_tax"));

        int act = Integer.parseInt(String.valueOf(lppaupto75_act.getText().toString()));
        int paodv = Integer.parseInt(String.valueOf(lppaupto75_paod_value.getText().toString()));
        int tax = (int)Math.round((act + paodv)*1.18);
        lppaupto75_total_premium.setText(String.valueOf(tax));

        shareBtn = (CircleButton) findViewById(R.id.sharebtnupto75);
        shareBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PermissionsChecker checker = new PermissionsChecker(lp_motorcycle_upto75.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(lp_motorcycle_upto75.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
    ...
    View.OnClickListener listener_homebtnupto75 = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(lp_motorcycle_upto75.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto75_act.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto75_paod_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ lppaupto75_total_premium.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            Uri uri = FileProvider.getUriForFile(lp_motorcycle_upto75.this,BuildConfig.APPLICATION_ID + ".provider",file);
