...
public class pp_motorcycle_upto350 extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener,ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    EditText pp_motorcycle_upto350_ndd_value;
    EditText pp_motorcycle_upto350_uwd_value;
    EditText pp_motorcycle_upto350_paod_value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(pp_motorcycle_upto350.this);
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        RadioButton pa_no =  findViewById(R.id.pp_motorcycle_upto350_paod_value_no);
        pa_no.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pp_motorcycle_upto350_paod_value.setText("0");
                pp_motorcycle_upto350_paod_value.setEnabled(false);
            }
        });
        RadioButton pa_yes = findViewById(R.id.pp_motorcycle_upto350_paod_value_yes);
        pa_yes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pp_motorcycle_upto350_paod_value.setText("320");
                pp_motorcycle_upto350_paod_value.setEnabled(true);
            }
        });
        ...
        ndd= (EditText) findViewById(R.id.pp_motorcycle_upto350_ndd_value);
    ...
    private void findAllViewsId() {
        ...
        pp_motorcycle_upto350_ndd_value = (EditText) findViewById(R.id.pp_motorcycle_upto350_ndd_value);
        pp_motorcycle_upto350_uwd_value = (EditText) findViewById(R.id.pp_motorcycle_upto350_uwd_value);
        pp_motorcycle_upto350_paod_value = findViewById(R.id.pp_motorcycle_upto350_paod);
    ...
    public void onClick(View v) {
        ...
        String ndd_value = pp_motorcycle_upto350_ndd_value.getText().toString();
 ...
 /*                   .setAction("Dismiss", new View.OnClickListener() {
            ...
            b.putString("pp_motorcycle_upto350_ndd_value", pp_motorcycle_upto350_ndd_value.getText().toString());
            b.putString("pp_motorcycle_upto350_uwd_value", pp_motorcycle_upto350_uwd_value.getText().toString());
            b.putString("pp_motorcycle_upto350_paod_value", pp_motorcycle_upto350_paod_value.getText().toString());
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if(ndd.getText().length()>0) {
                ...
                if (num>=0 && num<=35)
                {
                    ...
                    Toast.makeText(pp_motorcycle_upto350.this,"NDD range should be of 1-35",Toast.LENGTH_SHORT).show();
                    ndd.setText("");
                    num1=-1;
                }
            }
