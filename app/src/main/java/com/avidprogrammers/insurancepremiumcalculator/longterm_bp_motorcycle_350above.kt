 ...
 */
class longterm_bp_motorcycle_350above : AppCompatActivity(), AdapterView.OnItemSelectedListener,
    ...
    var lt_bp_motorcycle_350above: Button? = null
    var lt_bp_motorcycle_350above_idv_value: EditText? = null
    var lt_bp_motorcycle_350above_date_value: EditText? = null
    var lt_bp_motorcycle_350above_cc_value: EditText? = null
    var lt_bp_motorcycle_350above_nd_value: EditText? = null
    var lt_bp_motorcycle_350above_ndd_value: EditText? = null
    var lt_bp_motorcycle_350above_uwd_value: EditText? = null
    var lt_bp_motorcycle_350above_paod_value: EditText? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@longterm_bp_motorcycle_350above)
        ...
        val nd_no = findViewById<View>(R.id.lt_bp_motorcycle_350above_nd_no) as RadioButton
        nd_no.setOnClickListener {
            val ed1 = findViewById<View>(R.id.lt_bp_motorcycle_350above_nd_value) as EditText
            ed1.isEnabled = false
            ed1.setText("0")
        }
        val nd_yes = findViewById<View>(R.id.lt_bp_motorcycle_350above_nd_yes) as RadioButton
        ...
        val pa_no = findViewById<RadioButton>(R.id.lt_bp_motorcycle_above350_paod_value_no)
        pa_no.setOnClickListener {
            lt_bp_motorcycle_350above_paod_value!!.setText("0")
            lt_bp_motorcycle_350above_paod_value!!.isEnabled = false
        }
        val pa_yes = findViewById<RadioButton>(R.id.lt_bp_motorcycle_above350_paod_value_yes)
        pa_yes.setOnClickListener {
            lt_bp_motorcycle_350above_paod_value!!.setText("320")
            lt_bp_motorcycle_350above_paod_value!!.isEnabled = true
        }

        //Date-start
        mDateDisplay = findViewById<View>(R.id.lt_bp_motorcycle_350above_date_value) as TextView
        mPickDate = findViewById<View>(R.id.lt_bp_motorcycle_350above_date_btn) as Button
        ...
        //spinner-start
        val spin = findViewById<View>(R.id.lt_bp_motorcycle_350above_ncb) as Spinner
        spin.onItemSelectedListener = this
        val aa = ArrayAdapter(this, android.R.layout.simple_spinner_item, ncb)
        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        spin.adapter = aa
        //spinner-end
        findViewById<View>(R.id.lt_bp_motorcycle_350above_btn).setOnClickListener(
            listener_lt_bp_motorcycle_350above
        )
        ...
        //stop-passvalues
        ndd = findViewById<View>(R.id.lt_bp_motorcycle_350above_ndd_value) as EditText
        ndd!!.addTextChangedListener(textWatcher)
    }

    var listener_lt_bp_motorcycle_350above = View.OnClickListener {
        val intent = Intent(
            this@longterm_bp_motorcycle_350above,
            longterm_bpdisplay_motorcycle_350above::class.java
        )
    ...
    private fun findAllViewsId() {
        lt_bp_motorcycle_350above = findViewById<View>(R.id.lt_bp_motorcycle_350above_btn) as Button
        lt_bp_motorcycle_350above_idv_value =
            findViewById<View>(R.id.lt_bp_motorcycle_350above_idv_value) as EditText
        lt_bp_motorcycle_350above_date_value =
            findViewById<View>(R.id.lt_bp_motorcycle_350above_date_value) as EditText
        lt_bp_motorcycle_350above_cc_value =
            findViewById<View>(R.id.lt_bp_motorcycle_350above_cc_value) as EditText
        lt_bp_motorcycle_350above_nd_value =
            findViewById<View>(R.id.lt_bp_motorcycle_350above_nd_value) as EditText
        lt_bp_motorcycle_350above_ndd_value =
            findViewById<View>(R.id.lt_bp_motorcycle_350above_ndd_value) as EditText
        lt_bp_motorcycle_350above_uwd_value =
            findViewById<View>(R.id.lt_bp_motorcycle_350above_uwd_value) as EditText
        lt_bp_motorcycle_350above_paod_value = findViewById(R.id.lt_bp_motorcycle_above350_paod)
        zoneRadioGroup = findViewById<View>(R.id.lt_bp_motorcycle_350above_zone) as RadioGroup
        ndRadioGroup = findViewById<View>(R.id.lt_bp_motorcycle_350above_nd) as RadioGroup
    }

    override fun onClick(v: View) {
        //Check for any EditText being null
        val idv_value = lt_bp_motorcycle_350above_idv_value!!.text.toString()
        val uwd_value = lt_bp_motorcycle_350above_uwd_value!!.text.toString()
        val ndd_value = lt_bp_motorcycle_350above_ndd_value!!.text.toString()
        if (idv_value == "" || uwd_value == "" || ndd_value == "") {
            ...
            val intent =
                Intent(applicationContext, longterm_bpdisplay_motorcycle_350above::class.java)
            ...
            b.putString(
                "lt_bp_motorcycle_350above_idv_value",
                lt_bp_motorcycle_350above_idv_value!!.text.toString()
            )
            b.putString(
                "lt_bp_motorcycle_350above_date_value",
                lt_bp_motorcycle_350above_date_value!!.text.toString()
            )
            b.putString(
                "lt_bp_motorcycle_350above_cc_value",
                lt_bp_motorcycle_350above_cc_value!!.text.toString()
            )
            b.putString(
                "lt_bp_motorcycle_350above_nd_value",
                lt_bp_motorcycle_350above_nd_value!!.text.toString()
            )
            b.putString(
                "lt_bp_motorcycle_350above_ndd_value",
                lt_bp_motorcycle_350above_ndd_value!!.text.toString()
            )
            b.putString(
                "lt_bp_motorcycle_350above_uwd_value",
                lt_bp_motorcycle_350above_uwd_value!!.text.toString()
            )
            b.putString(
                "lt_bp_motorcycle_350above_paod_value",
                lt_bp_motorcycle_350above_paod_value!!.text.toString()
            )
            val id1 = zoneRadioGroup!!.checkedRadioButtonId
            val radioButton1 = findViewById<View>(id1) as RadioButton
            b.putString("lt_bp_motorcycle_350above_zone", radioButton1.text.toString())
            val id2 = ndRadioGroup!!.checkedRadioButtonId
            val radioButton2 = findViewById<View>(id2) as RadioButton
            b.putString("lt_bp_motorcycle_350above_nd", radioButton2.text.toString())
...
// TODO Auto-generated method stub
    ...
    companion object {
        private const val TAG = "lt_bp_motorcycle_350above"
