...
class pp_bus_upto18 : AppCompatActivity(), AdapterView.OnItemSelectedListener, View.OnClickListener,
    ...
    fun nd() {
        ...
        if (pp_bus_upto18_nd_value_yes!!.isChecked) {
            if (x < 182) {
                pp_bus_upto18_nd_value!!.setText("10", TextView.BufferType.EDITABLE)
            } else if (x in 182..729) {
                pp_bus_upto18_nd_value!!.setText("20", TextView.BufferType.EDITABLE)
            } else if (x in 730..1824) {
                pp_bus_upto18_nd_value!!.setText("30", TextView.BufferType.EDITABLE)
            } else if (x >= 1825) {
