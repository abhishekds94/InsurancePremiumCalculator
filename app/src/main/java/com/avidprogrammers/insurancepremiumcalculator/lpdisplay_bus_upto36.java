...
public class lpdisplay_bus_upto36 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    TextView lp_bus_upto36_act;
    TextView lp_bus_upto36_paod;
    TextView lp_bus_upto36_tax;

    TextView lp_bus_scpassengers_upto36;
    TextView lp_bus_driver_upto36;
    TextView lp_bus_conductor_upto36;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(lpdisplay_bus_upto36.this);
        ...
        Bundle b = getIntent().getExtras();
         lp_bus_upto36_act = (TextView) findViewById(R.id.lpdisplay_bus_upto36_act_value);
         lp_bus_upto36_paod = (TextView) findViewById(R.id.lpdisplay_bus_upto36_paod_value);
         lp_bus_upto36_tax = (TextView) findViewById(R.id.lpdisplay_bus_upto36_tax_value);

         lp_bus_scpassengers_upto36 = (TextView) findViewById(R.id.lpdisplay_bus_upto36_passrisk_value);
         lp_bus_driver_upto36 = (TextView) findViewById(R.id.lpdisplay_bus_upto36_lldriver_value);
         lp_bus_conductor_upto36 = (TextView) findViewById(R.id.lpdisplay_bus_upto36_llconductor_value);
         lp_bus_total_premium=(TextView)findViewById(R.id.lpdisplay_bus_upto36_total_value);

        lp_bus_upto36_act.setText(b.getCharSequence("lp_bus_upto36_act"));
        ...
        //
        lp_bus_scpassengers_upto36.setText(String.valueOf(Integer.parseInt(String.valueOf(b.getCharSequence("lp_bus_scpassengers_upto36")))*897));
        ...
        findViewById(R.id.lpdisplay_bus_upto36_home).setOnClickListener(listener_lpdisplay_bus_upto36_home);

        share_btn = (CircleButton) findViewById(R.id.lpdisplay_bus_upto36_share);
        share_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PermissionsChecker checker = new PermissionsChecker(lpdisplay_bus_upto36.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(lpdisplay_bus_upto36.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
    ...
    View.OnClickListener listener_lpdisplay_bus_upto36_home = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(lpdisplay_bus_upto36.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_bus_upto36_act.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_bus_upto36_paod.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_bus_scpassengers_upto36.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_bus_driver_upto36.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(lp_bus_conductor_upto36.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            Uri uri = FileProvider.getUriForFile(lpdisplay_bus_upto36.this, BuildConfig.APPLICATION_ID + ".provider",file);
