...
public class lpdisplay_car_upto1500 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    TextView lp_car_upto1500_act;
    TextView lp_car_upto1500_paod;
    TextView lp_car_upto1500_ll;
    TextView lp_car_upto1500_tax;

    TextView lp_car_upto1500_lpgkit;
    TextView lp_car_upto1500_total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(lpdisplay_car_upto1500.this);
        ...
        Bundle b = getIntent().getExtras();
         lp_car_upto1500_act = (TextView) findViewById(R.id.lpdisplay_car_upto1500_act_value);
         lp_car_upto1500_paod = (TextView) findViewById(R.id.lpdisplay_car_upto1500_paod_value);
         lp_car_upto1500_ll = (TextView) findViewById(R.id.lpdisplay_car_upto1500_ll_value);
         lp_car_upto1500_tax = (TextView) findViewById(R.id.lpdisplay_car_upto1500_tax_value);

         lp_car_upto1500_lpgkit = (TextView) findViewById(R.id.lpdisplay_car_upto1500_lpgkit_value);
         lp_car_upto1500_total = (TextView) findViewById(R.id.lpdisplay_car_upto1500_total_value);
        ...
        shareBtn = (CircleButton) findViewById(R.id.lpdisplay_car_upto1500_share);
        shareBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PermissionsChecker checker = new PermissionsChecker(lpdisplay_car_upto1500.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(lpdisplay_car_upto1500.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
    ...
    View.OnClickListener listener_lpdisplay_car_upto1500_home = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(lpdisplay_car_upto1500.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_car_upto1500_act.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_car_upto1500_paod.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_car_upto1500_ll.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(lp_car_upto1500_lpgkit.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+lp_car_upto1500_total.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            Uri uri = FileProvider.getUriForFile(lpdisplay_car_upto1500.this, BuildConfig.APPLICATION_ID + ".provider",file);
