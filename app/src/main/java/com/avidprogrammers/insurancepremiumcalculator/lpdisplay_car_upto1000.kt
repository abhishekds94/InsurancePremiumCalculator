 ...
 */
class lpdisplay_car_upto1000 : AppCompatActivity(), ConnectivityReceiverListener {
    ...
    var file: File? = null
    var lp_car_upto1000_act: TextView? = null
    var lp_car_upto1000_paod: TextView? = null
    var lp_car_upto1000_ll: TextView? = null
    var lp_car_upto1000_tax: TextView? = null
    var lp_car_upto1000_lpgkit: TextView? = null
    var lp_car_upto1000_total: TextView? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@lpdisplay_car_upto1000)
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        lp_car_upto1000_act = findViewById<View>(R.id.lpdisplay_car_upto1000_act_value) as TextView?
        lp_car_upto1000_paod =
            findViewById<View>(R.id.lpdisplay_car_upto1000_paod_value) as TextView?
        lp_car_upto1000_ll = findViewById<View>(R.id.lpdisplay_car_upto1000_ll_value) as TextView?
        lp_car_upto1000_tax = findViewById<View>(R.id.lpdisplay_car_upto1000_tax_value) as TextView?
        lp_car_upto1000_lpgkit =
            findViewById<View>(R.id.lpdisplay_car_upto1000_lpgkit_value) as TextView?
        lp_car_upto1000_total =
            findViewById<View>(R.id.lpdisplay_car_upto1000_total_value) as TextView?
        lp_car_upto1000_act!!.text = b.getCharSequence("lp_car_upto1000_act")
        lp_car_upto1000_paod!!.text = b.getCharSequence("lp_car_upto1000_paod")
        lp_car_upto1000_ll!!.text = b.getCharSequence("lp_car_upto1000_ll")
        lp_car_upto1000_tax!!.text = b.getCharSequence("lp_car_upto1000_tax")
        lp_car_upto1000_lpgkit!!.text = b.getCharSequence("lp_car_upto1000_lpgkit")
        getSupportActionBar()!!.setDisplayHomeAsUpEnabled(true)
        getSupportActionBar()!!.setTitle("Car Liability Policy")
        shareBtn = findViewById<View>(R.id.lpdisplay_car_upto1000_share) as CircleButton?
        shareBtn!!.setOnClickListener {
            val checker = PermissionsChecker(this@lpdisplay_car_upto1000)
            if (checker.lacksPermissions(*PermissionsChecker.REQUIRED_PERMISSION)) {
                PermissionsActivity.startActivityForResult(
                    this@lpdisplay_car_upto1000,
        ...
        val radio_button_value = b.getString("lp_car_upto1000_lpgkit")
        val yes: String = "Yes"
        ...
        lp_car_upto1000_total!!.text = rounded_total_premium_int.toString()
        findViewById<View>(R.id.lpdisplay_car_upto1000_home).setOnClickListener(
            listener_lpdisplay_car_upto1000_home
        )
    }

    var listener_lpdisplay_car_upto1000_home = View.OnClickListener {
        val intent = Intent(this@lpdisplay_car_upto1000, home_activity::class.java)
    ...
    private fun settingUpPDF(document: Document) {
        ...
        try {
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_upto1000_act!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_upto1000_paod!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_upto1000_ll!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lp_car_upto1000_lpgkit!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_upto1000_total!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
