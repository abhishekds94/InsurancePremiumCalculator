 ...
 */
class lpdisplay_car_above1500 : AppCompatActivity(), ConnectivityReceiverListener {
    ...
    var lp_car_above1500_act: TextView? = null
    var lp_car_above1500_paod: TextView? = null
    var lp_car_above1500_ll: TextView? = null
    var lp_car_above1500_tax: TextView? = null
    var lp_car_above1500_lpgkit: TextView? = null
    var lp_car_above1500_total: TextView? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@lpdisplay_car_above1500)
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        lp_car_above1500_act =
            findViewById<View>(R.id.lpdisplay_car_above1500_act_value) as TextView?
        lp_car_above1500_paod =
            findViewById<View>(R.id.lpdisplay_car_above1500_paod_value) as TextView?
        lp_car_above1500_ll = findViewById<View>(R.id.lpdisplay_car_above1500_ll_value) as TextView?
        lp_car_above1500_tax =
            findViewById<View>(R.id.lpdisplay_car_above1500_tax_value) as TextView?
        lp_car_above1500_lpgkit =
            findViewById<View>(R.id.lpdisplay_car_above1500_lpgkit_value) as TextView?
        lp_car_above1500_total =
            findViewById<View>(R.id.lpdisplay_car_above1500_total_value) as TextView?
        lp_car_above1500_act!!.text = b.getCharSequence("lp_car_above1500_act")
        lp_car_above1500_paod!!.text = b.getCharSequence("lp_car_above1500_paod")
        lp_car_above1500_ll!!.text = b.getCharSequence("lp_car_above1500_ll")
        lp_car_above1500_tax!!.text = b.getCharSequence("lp_car_above1500_tax")
        lp_car_above1500_lpgkit!!.text = b.getCharSequence("lp_car_above1500_lpgkit")
        getSupportActionBar()!!.setDisplayHomeAsUpEnabled(true)
        getSupportActionBar()!!.setTitle("Car Liability Policy")
        val radio_button_value = b.getString("lp_car_above1500_lpgkit")
        val yes: String = "Yes"
        shareBtn = findViewById<View>(R.id.lpdisplay_car_above1500_share) as CircleButton?
        shareBtn!!.setOnClickListener {
            val checker = PermissionsChecker(this@lpdisplay_car_above1500)
            if (checker.lacksPermissions(*PermissionsChecker.REQUIRED_PERMISSION)) {
                PermissionsActivity.startActivityForResult(
                    this@lpdisplay_car_above1500,
        ...
        lp_car_above1500_total!!.text = rounded_total_premium_int.toString()
        findViewById<View>(R.id.lpdisplay_car_above1500_home).setOnClickListener(
            listener_lpdisplay_car_above1500_home
        )
    }

    var listener_lpdisplay_car_above1500_home = View.OnClickListener {
        val intent = Intent(this@lpdisplay_car_above1500, home_activity::class.java)
    ...
    private fun settingUpPDF(document: Document) {
        ...
        try {
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_above1500_act!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_above1500_paod!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_above1500_ll!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk(lp_car_above1500_lpgkit!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lp_car_above1500_total!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
