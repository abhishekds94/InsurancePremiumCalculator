...
public class ppdisplay_motorcycle_upto350 extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    File file;
    TextView pp_motorcycle_upto350_IDV_value;
    TextView pp_motorcycle_upto350_date_value;
    TextView pp_motorcycle_upto350_zone_value;
    TextView pp_motorcycle_upto350_cc_value;
    TextView pp_motorcycle_upto350_nd_value;
    TextView pp_motorcycle_upto350_ndd_value;
    TextView pp_motorcycle_upto350_uwd_value;
    TextView pp_motorcycle_upto350_ncb_value;
    TextView pp_motorcycle_upto350_od_value;
    TextView pp_motorcycle_upto350_ab_value;
    TextView pp_motorcycle_upto350_b_value;
    TextView ppdisplay_motorcycle_upto350_paod_value;
    TextView ppdisplay_motorcycle_upto350_total_value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkfunction(ppdisplay_motorcycle_upto350.this);
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        Bundle b = getIntent().getExtras();
         pp_motorcycle_upto350_IDV_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_IDV_value);
         pp_motorcycle_upto350_date_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_date_value);
         pp_motorcycle_upto350_zone_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_zone_value);
         pp_motorcycle_upto350_cc_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_cc_value);
         pp_motorcycle_upto350_nd_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_nd_value);
         pp_motorcycle_upto350_ndd_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_ndd_value);
         pp_motorcycle_upto350_uwd_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_uwd_value);
         pp_motorcycle_upto350_ncb_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_ncb_value);
         pp_motorcycle_upto350_od_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_od_value);
         pp_motorcycle_upto350_ab_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_ab_value);
         pp_motorcycle_upto350_b_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_b_value);
        ppdisplay_motorcycle_upto350_paod_value = findViewById(R.id.ppdisplay_motorcycle_upto350_pa_value);
         ppdisplay_motorcycle_upto350_total_value = (TextView) findViewById(R.id.ppdisplay_motorcycle_upto350_total_value);
        share_btn = (CircleButton) findViewById(R.id.ppdisplay_motorcycle_upto350_share);
        ...
        pp_motorcycle_upto350_ndd_value.setText(b.getCharSequence("pp_motorcycle_upto350_ndd_value"));
        pp_motorcycle_upto350_uwd_value.setText(b.getCharSequence("pp_motorcycle_upto350_uwd_value"));
        ppdisplay_motorcycle_upto350_paod_value.setText(b.getCharSequence("pp_motorcycle_upto350_paod_value"));
        ...
        share_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PermissionsChecker checker = new PermissionsChecker(ppdisplay_motorcycle_upto350.this);
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {

                    PermissionsActivity.startActivityForResult(ppdisplay_motorcycle_upto350.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
...
//Calculation of ND value
        ...
        String radio_button_value=b.getString("pp_motorcycle_upto350_nd");
        ...
        double ndd_value = Integer.valueOf(b.getString("pp_motorcycle_upto350_ndd_value"));
        ...
        pp_total_premium = 1366 + Integer.valueOf(ppdisplay_motorcycle_upto350_paod_value.getText().toString());


        double total=1366+ Integer.valueOf(ppdisplay_motorcycle_upto350_paod_value.getText().toString());
    ...
    View.OnClickListener listener_ppdisplay_motorcycle_upto350_home = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(ppdisplay_motorcycle_upto350.this, home_activity.class);
    ...
    private void settingUpPDF(Document document)
    {
        ...
        try {
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+pp_motorcycle_upto350_IDV_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_date_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_zone_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_cc_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_nd_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_ndd_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_uwd_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk(pp_motorcycle_upto350_ncb_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+pp_motorcycle_upto350_od_value.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ppdisplay_motorcycle_upto350_paod_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+pp_motorcycle_upto350_b_value.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+pp_motorcycle_upto350_ab_value.getText().toString()));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.WHITE);
            pdfPCell.addElement(p);
            table.addCell(pdfPCell);
            ...
            p = new Paragraph();
            p.add(new Chunk("Rs. "+ppdisplay_motorcycle_upto350_total_value.getText().toString(),white));
            pdfPCell = new PdfPCell();
            pdfPCell.setBorderColor(BaseColor.BLACK);
            pdfPCell.setBackgroundColor(BaseColor.BLACK);
            pdfPCell.addElement(p);
            ...
            Uri uri = FileProvider.getUriForFile(ppdisplay_motorcycle_upto350.this, BuildConfig.APPLICATION_ID + ".provider",file);
