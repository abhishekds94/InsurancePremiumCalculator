 ...
 */
class longterm_ppdisplay_car_upto1000 : AppCompatActivity(), ConnectivityReceiverListener {
    ...
    var lt_ppdisplay_car_upto1000_ab_value: TextView? = null
    var lt_ppdisplay_car_upto1000_lpgkit_value: TextView? = null
    var lt_ppdisplay_car_upto1000_pa_pass_value: TextView? = null
    var lt_ppdisplay_car_upto1000_total_value: TextView? = null
    ...
    protected override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkfunction(this@longterm_ppdisplay_car_upto1000)
...
/*        mAdView = (AdView) findViewById(R.id.adView);
        ...
        lt_bp_car_upto1000_IDV_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_IDV_value) as TextView?
        lt_bp_car_upto1000_date_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_date_value) as TextView?
        lt_bp_car_upto1000_zone =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_zone_value) as TextView?
        lt_bp_car_upto1000_cc_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_cc_value) as TextView?
        lt_bp_car_upto1000_nd_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_nd_value) as TextView?
        lt_bp_car_upto1000_ndd_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_ndd_value) as TextView?
        lt_bp_car_upto1000_uwd_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_uwd_value) as TextView?
        lt_bp_car_upto1000_ncb_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_ncb_value) as TextView?
        lt_bp_car_upto1000_lpg_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_lpg_value) as TextView?
        lt_bp_car_upto1000_lpgtype_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_lpgtype_value) as TextView?
        lt_bp_car_upto1000_antitheft =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_antitheft_value) as TextView?
        lt_bp_car_upto1000_paod_value =
            findViewById<TextView>(R.id.lt_ppdisplay_car_upto1000_pa_value)
        lt_bp_car_upto1000_od_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_od_value) as TextView?
        lt_bp_car_upto1000_value_b =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_b_value) as TextView?
        lt_ppdisplay_car_upto1000_ab_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_ab_value) as TextView?
        lt_ppdisplay_car_upto1000_lpgkit_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_lpgkit_value) as TextView?
        lt_ppdisplay_car_upto1000_pa_pass_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_pa_pass_value) as TextView?
        lt_ppdisplay_car_upto1000_total_value =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_total_value) as TextView?
        ...
        findViewById<View>(R.id.lt_ppdisplay_car_upto1000_home).setOnClickListener(
            listener_lt_ppdisplay_car_upto1000_home
        )
        share_btn =
            findViewById<View>(R.id.lt_ppdisplay_car_upto1000_share) as CircleButton?
        share_btn!!.setOnClickListener {
            val checker = PermissionsChecker(this@longterm_ppdisplay_car_upto1000)
            if (checker.lacksPermissions(*PermissionsChecker.REQUIRED_PERMISSION)) {
                PermissionsActivity.startActivityForResult(
                    this@longterm_ppdisplay_car_upto1000,
        ...
        if (b.getString("lt_bp_car_upto1000_nd_value") == x2) {
            ...
            val idv_value =
                Integer.valueOf(b.getString("lt_bp_car_upto1000_idv_value")).toDouble()
        ...
        lt_ppdisplay_car_upto1000_pa_pass_value!!.text = lt_bp_pa_pass_value.toString()
        ...
        lt_ppdisplay_car_upto1000_lpgkit_value!!.text = lt_bp_lgkit_assumevalue.toString()
        val total = 5286.00 + java.lang.Double.valueOf(
        ...
        lt_ppdisplay_car_upto1000_ab_value!!.text = total_ab_int.toString()
        ...
        lt_ppdisplay_car_upto1000_total_value!!.text = rounded_total_AB_int.toString()
    }

    var listener_lt_ppdisplay_car_upto1000_home = View.OnClickListener {
        val intent = Intent(this@longterm_ppdisplay_car_upto1000, home_activity::class.java)
    ...
    private fun settingUpPDF(document: Document) {
        ...
        try {
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_ppdisplay_car_upto1000_pa_pass_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_ppdisplay_car_upto1000_lpgkit_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_ppdisplay_car_upto1000_ab_value!!.text.toString()))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.WHITE
            pdfPCell.addElement(p)
            table.addCell(pdfPCell)
            ...
            table.addCell(pdfPCell)
            p = Paragraph()
            p.add(Chunk("Rs. " + lt_ppdisplay_car_upto1000_total_value!!.text.toString(), white))
            pdfPCell = PdfPCell()
            pdfPCell.borderColor = BaseColor.BLACK
            pdfPCell.backgroundColor = BaseColor.BLACK
            pdfPCell.addElement(p)
